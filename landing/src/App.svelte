...
<div class="min-h-screen relative" onmousemove={handleMouseMove}>
  ...
  <section class="py-24 px-6">
    <div class="max-w-lg mx-auto text-center">
      <h2 class="text-2xl md:text-3xl font-bold mb-4">Join the community</h2>
      ...
      <a
        ...
        class="inline-flex items-center gap-3 px-8 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-xl font-medium transition-all shadow-lg shadow-[#5865F2]/25"
      >
  ...
  <footer class="py-12 px-6 border-t border-border bg-bg-secondary">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mt-8 pt-8 border-t border-border text-center text-xs text-zinc-500">
        <p>&copy; 2025 <a href="https://ezcorp.org" target="_blank" rel="noopener noreferrer" class="text-accent hover:underline">EZCorp</a>. Privacy first. Always.</p>
        <p class="mt-1 text-zinc-600">Built with ❤️ for developers who value the EZ life.</p>
      </div>
    </div>
  </footer>
